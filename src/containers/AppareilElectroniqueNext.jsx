...
const AppareilElectroniqueNext = ({ addshop }) => {
  const { id } = useParams(); //useparams permet d avoir acces au elements de l'url(route).
  const free = appareilelectroniques.find((p) => p.id.toString() === id); //find permet de parcourir les elements du tableau et de retourner le premier elements
    ...
    <div className="Next-Step">
      ...
      <div className="Next-Step-Down">
        ...
        <table>
          ...
          <tr>
            <td>connectivité</td>
            <td>{free.connectivite}</td>
          </tr>
          <tr>
            <td>distributeur</td>
            <td>{free.distributeur}</td>
          </tr>
          <tr>
            <td>dimension</td>
...
export default AppareilElectroniqueNext;
