...
const TvNext = ({ addshop, addcompteur }) => {
  const navigate = useNavigate();
  const { id } = useParams(); //useparams permet d avoir acces au elements de l'url(route).
  const free = television.find((p) => p.id.toString() === id); //find permet de parcourir les elements du tableau et de retourner le premier elements
  //selection photo
    ...
    <div className="Next-Step">
      ...
      <div className="Next-Step-Down">
        ...
        <table>
          <tr>
            <td>Taille</td>
            <td>{free.taille_ecran} </td>
          </tr>
          <tr>
            <td>type d'ecran</td>
            <td>{free.type_ecran} </td>
          </tr>
          <tr>
            <td>résolution</td>
            <td>{free.resolution} </td>
          </tr>
          <tr>
            <td>son</td>
            <td>{free.son} cm</td>
